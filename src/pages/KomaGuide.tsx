...
import { BookOpen, Settings, Search, Download, AlertTriangle, ArrowLeft } from 'lucide-react';
            ...
            <div className="container mx-auto px-6 md:px-8 relative z-10">
                <div className="max-w-4xl mx-auto">
                    ...
                    <motion.div 
                        ...
                        className="mb-16"
                    >
                        <div className="inline-flex items-center justify-center p-4 rounded-xl bg-accent/10 border border-accent/20 mb-6 text-accent">
                        ...
                        {text.steps.map((step, index) => (
                            ...
                            >
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <h2 className="text-2xl font-bold text-white font-heading">{step.title}</h2>
                                </div>
