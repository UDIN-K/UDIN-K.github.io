...
This strategy helps reduce unnecessary requests which may lead to sources implementing measures against **Koma** or your extensions.
* We recommend to prioritize reading your unread chapters, and letting **Koma** update the library by itself to better adapt & predict chapter releases over time.
...
**Koma** provides a reminder when updating multiple titles or bulk downloading chapters, since excessive requests may trigger a source's anti-bot measures.
...
* Whitelist **Koma** from your battery saver by going to <nav to="advanced"> and tapping **Disable battery optimization**.
...
**Koma** can't sync between devices.
...
**Koma** detects these changes and interprets the chapters as new.
