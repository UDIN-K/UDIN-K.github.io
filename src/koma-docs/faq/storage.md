...
Koma manages several things within a selected storage location, including automatic backups, chapter downloads, and the Local source.

::: tip Selecting a storage location
Keep the following in mind when setting up your Storage location:
* Create a "Koma" folder at the top-level of your storage (ex. `/Internal Storage/Koma/`).
...
* When selecting your storage location during the setup process, give access to the "Koma" folder, not the folders within.
:::
...
<div class="tree">
  <ul>
    ...
    <li>
      ...
      <ul>
        <li>
          <img src="/img/koma-64px.png" alt="File" class="tree-icon icon-koma">
          <span class="file jpg">app.koma_yyyy-mm-dd_hh-mm<span class="file-extension">.tachibk</span></span>
        </li>
        <li>
          <img src="/img/koma-64px.png" alt="File" class="tree-icon icon-koma">
          <span>...</span>
...
**Scoped Storage**'s introduction affects various storage-related functions in **Koma**.
