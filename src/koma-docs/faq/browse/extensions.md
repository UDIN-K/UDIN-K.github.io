...
## Where can I find repositories/extensions for Koma?
Koma does not have, associate, or provide any repositories or extensions.
...
Koma is bring-your-own-content and does not offer anything.

::: info Disclaimer
**Koma** isn't responsible for slow, down, missing chapters, or subpar image quality of sources as it doesn't host the content.
:::
...
Uninstall extensions like regular apps: through device settings or in **Koma**.

::: tip Uninstalling an extension
In **Koma**, uninstall an extension via <nav to="extensions">, then tap **Uninstall** on the chosen extension.
:::
