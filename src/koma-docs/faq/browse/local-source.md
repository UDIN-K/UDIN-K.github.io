...
## What should I do if I can't find the Koma folder?
In case the **Koma** folder is not visible, create one using a file manager.
...
Related GitHub Issue: [#932](https://git.koma.tech/tachiyomi/tachiyomi/issues/932)
