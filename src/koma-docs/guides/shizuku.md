...
description: Using Shizuku with Koma.
---

# Shizuku
**Shizuku** is an alternative method for installing and updating extensions in **Koma**.
...
After configuring it, enable **Shizuku** within **Koma** by navigating to <nav to="advanced"> then changing the **Installer** setting.
