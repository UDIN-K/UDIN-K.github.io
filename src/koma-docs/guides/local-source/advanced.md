...
```
::: tip
If you don't want to create the `details.json` file manually, you can use the android app [Koguma-Metadata](https://github.com/ghostbear/koguma-metadata/releases/latest), or [this website](https://local.koma.tools).
:::
