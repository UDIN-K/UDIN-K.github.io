      ...
      <div className="container mx-auto px-6 md:px-8 relative z-10">
        <div className="grid md:grid-cols-4 gap-12 mb-20">
          ...
          <div className="col-span-2 space-y-8">
            ...
            <p className="text-slate-500 text-sm leading-loose max-w-sm font-mono transition-colors duration-400">
            ...
            <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest">Signal Online</span>
                </div>
            </div>
          </div>
             ...
             <ul className="space-y-4 text-xs font-mono text-slate-500 uppercase tracking-tighter">
              ...
              <li>
                <a
                  ...
                  className="hover:text-accent transition-colors flex items-center justify-between group"
                >
                   <span>koma.udink.me</span>
                   <ArrowUpRight className="w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity" />
                </a>
              </li>
              <li>
