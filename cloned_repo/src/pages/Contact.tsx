...
export const Contact: React.FC = () => {
    ...
    const transmit = () => {
        setStep('SENDING');
        setLines(prev => [...prev, '[EXEC] Encrypting using 4096-bit AES...', '[EXEC] Routing through anonymized relays...', '[EXEC] Transmitting packet to MUHAMMAD_SYAFRI...']);
            ...
            <div className="container mx-auto px-4 md:px-8 relative z-20">
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="mt-8 flex justify-between items-center">
                        ...
                        <span className="text-[8px] text-slate-700 font-mono tracking-widest uppercase">SYAFRI_GATE_PORT_0x80</span>
                    </div>
                </div>
            </div>
