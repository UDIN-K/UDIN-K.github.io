...
import { BookOpen, Plug, Wrench, Download, GitBranch, MessageSquare, ArrowRight, GitCommitVertical, X, Loader2, Lock, XCircle, Search, Filter, Library, Clock, Compass, MoreHorizontal, Battery, Wifi } from 'lucide-react';
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20 max-w-6xl mx-auto mb-20 px-4">
                        ...
                        <div className="flex-1 w-full max-w-sm flex justify-center lg:justify-end">
                            ...
                            <motion.div
                                ...
                                className="relative w-full max-w-[290px] aspect-[1/2.15] bg-black rounded-[3rem] border border-slate-700/50 p-2 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.5),0_0_80px_rgba(56,189,248,0.15)] flex flex-col ring-[6px] ring-[#12141c]"
                            >
                                <div className="absolute -left-1.5 top-24 w-1 h-12 bg-slate-800 rounded-l-md"></div>
                                <div className="absolute -left-1.5 top-40 w-1 h-12 bg-slate-800 rounded-l-md"></div>
                                <div className="absolute -right-1.5 top-32 w-1 h-16 bg-slate-800 rounded-r-md"></div>

                                <div className="w-full h-full bg-[#0d0f14] rounded-[2.5rem] overflow-hidden flex flex-col relative font-sans group">
                                    
                                    {/* Glass reflection effect */}
                                    <div className="absolute inset-x-0 -top-10 h-40 bg-white/5 skew-y-12 blur-xl pointer-events-none group-hover:bg-white/10 transition-colors duration-1000"></div>

                                    {/* Status Bar */}
                                    <div className="h-8 w-full px-5 flex justify-between items-center text-[10px] font-bold text-slate-300 relative z-20 shrink-0">
                                        <span>12:00</span>
                                        {/* Dynamic Island */}
                                        <div className="absolute left-1/2 -translate-x-1/2 top-1.5 w-20 h-5 bg-black rounded-full flex items-center justify-between px-1.5">
                                            <div className="w-3 h-3 rounded-full bg-slate-900 overflow-hidden relative">
                                                <div className="absolute inset-0 bg-indigo-500/20"></div>
                                            </div>
                                            <div className="w-1.5 h-1.5 rounded-full bg-green-500 mr-2 opacity-80 shadow-[0_0_4px_#22c55e]"></div>
                                        </div>
                                        <div className="flex items-center gap-1.5 opacity-90">
                                            <svg className="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M2 20h.01M7 20v-4M12 20v-8M17 20V8M22 4v16"/></svg>
                                    ...
                                    {/* App Header */}
                                    <div className="px-5 pt-4 pb-2 z-10 shrink-0">
                                        <div className="flex justify-between items-center mb-4">
                                            <h3 className="text-xl font-black bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent">Library</h3>
                                    ...
                                    {/* Library Content */}
                                    <div className="flex-1 overflow-hidden px-4 pb-24 z-0">
                                        {/* Filter tags */}
                                        <div className="flex gap-2 mb-4 overflow-x-auto custom-scrollbar pb-1">
                                            <div className="px-3 py-1 rounded-full bg-accent/10 border border-accent/20 text-accent text-[10px] font-bold whitespace-nowrap">Unread</div>
                                            <div className="px-3 py-1 rounded-full bg-slate-800/50 border border-slate-700/50 text-slate-300 text-[10px] font-bold whitespace-nowrap">Downloaded</div>
                                            <div className="px-3 py-1 rounded-full bg-slate-800/50 border border-slate-700/50 text-slate-300 text-[10px] font-bold whitespace-nowrap">Completed</div>
                                        </div>

                                        <div className="grid grid-cols-2 gap-3 pb-8 relative">
                                            <div className="aspect-[5/7] bg-gradient-to-br from-indigo-500/80 to-purple-800/80 rounded-xl relative overflow-hidden shadow-lg border border-white/10 group-hover:border-accent/30 transition-colors duration-500">
                                                <div className="absolute top-1.5 left-1.5 bg-slate-900/80 backdrop-blur-md text-white text-[9px] px-1.5 py-0.5 rounded font-bold border border-white/10 shadow-sm z-10">13</div>
                                                <div className="absolute inset-x-0 bottom-0 top-1/2 bg-gradient-to-t from-black via-black/60 to-transparent"></div>
                                                <div className="absolute bottom-2 left-2 right-2">
                                                    <div className="text-[10px] font-bold text-white shadow-sm leading-tight mb-1">Solo Leveling</div>
                                                    <div className="text-[8px] text-slate-300">Action, Fantasy</div>
                                                </div>
                                            </div>
                                            <div className="aspect-[5/7] bg-gradient-to-br from-emerald-500/80 to-teal-800/80 rounded-xl relative overflow-hidden shadow-lg border border-white/10">
                                                <div className="absolute top-1.5 left-1.5 bg-accent text-slate-950 text-[9px] px-1.5 py-0.5 rounded font-bold shadow-sm z-10">New</div>
                                                <div className="absolute inset-x-0 bottom-0 top-1/2 bg-gradient-to-t from-black via-black/60 to-transparent"></div>
                                                <div className="absolute bottom-2 left-2 right-2">
                                                    <div className="text-[10px] font-bold text-white shadow-sm leading-tight mb-1">Omniscient Reader</div>
                                                    <div className="text-[8px] text-slate-300">Action</div>
                                                </div>
                                            </div>
                                            <div className="aspect-[5/7] bg-gradient-to-br from-rose-500/80 to-pink-800/80 rounded-xl relative overflow-hidden shadow-lg border border-white/10">
                                                <div className="absolute inset-x-0 bottom-0 top-1/2 bg-gradient-to-t from-black via-black/60 to-transparent"></div>
                                                <div className="absolute bottom-2 left-2 right-2">
                                                    <div className="text-[10px] font-bold text-white shadow-sm leading-tight mb-1">Oshi no Ko</div>
                                                    <div className="text-[8px] text-slate-300">Drama</div>
                                                </div>
                                            </div>
                                            <div className="aspect-[5/7] bg-gradient-to-br from-amber-500/80 to-orange-800/80 rounded-xl relative overflow-hidden shadow-lg border border-white/10">
                                                <div className="absolute top-1.5 left-1.5 bg-slate-900/80 backdrop-blur-md text-slate-300 text-[9px] px-1.5 py-0.5 rounded font-bold border border-white/10 shadow-sm z-10">End</div>
                                                <div className="absolute inset-x-0 bottom-0 top-1/2 bg-gradient-to-t from-black via-black/60 to-transparent"></div>
                                                <div className="absolute bottom-2 left-2 right-2">
                                                    <div className="text-[10px] font-bold text-white shadow-sm leading-tight mb-1">Chainsaw Man</div>
                                                    <div className="text-[8px] text-slate-300">Horror</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="absolute bottom-4 left-0 w-full px-4 z-50">
                                        <div className="h-14 bg-slate-900/70 backdrop-blur-xl border border-slate-700/50 rounded-full flex justify-around items-center px-2 shadow-[0_10px_20px_rgba(0,0,0,0.4)]">
                                            <div className="flex flex-col items-center justify-center gap-0.5 w-10 text-accent">
                                                <Library className="w-5 h-5 fill-accent/20" />
                                                <span className="text-[8px] font-bold">Library</span>
                                            </div>
                                            <div className="flex flex-col items-center justify-center gap-0.5 w-10 text-slate-400 hover:text-slate-300 transition-colors">
                                    ...
                                    {/* Bottom fade for island nav */}
                                    <div className="absolute bottom-0 left-0 w-full h-24 bg-gradient-to-t from-[#0d0f14] to-transparent pointer-events-none z-40"></div>
                                </div>
                            </motion.div>
                        </div>
                    </div>
